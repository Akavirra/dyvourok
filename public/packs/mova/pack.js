...
(window.DYVO_PACKS = window.DYVO_PACKS || []).push({
  ...
  stops: [
    ...
    },
    {
      ...
      task: {
        ...
        prompt: 'Літописець записує події по порядку. Натискай картки від найдавнішої події до найновішої.',
        items: [
          'Кирило і Мефодій створюють абетку',
          'Нестор пише літопис',
          'Тарас Шевченко видає «Кобзар»',
          'Уся країна пише Радіодиктант єдності'
        ]
      }
    },
    {
  ...
  teacher: {
    ...
    answers: [
      'Глаголиця: МОВА.',
      'Літопис: абетка → літопис → «Кобзар» → радіодиктант.',
